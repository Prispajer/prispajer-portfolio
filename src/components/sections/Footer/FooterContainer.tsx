...
const FooterContainer = () => {
    return (
        <footer className="relative w-full h-full">
            <motion.div initial="hidden" whileInView="show" variants={fadeWhileLoading(-160, 0, 0)} viewport={{ once: true, amount: 0.2 }} className="w-full h-1 bg-gradient-to-r from-crimson/40 via-crimson/40 to-crimson/40"></motion.div>
