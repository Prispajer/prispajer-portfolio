...
const ContactContainer = () => {
    return (
        <section id="contact" className="relative flex items-center justify-center pt-15 sm:pt-30 pb-15 sm:pb-60 overflow-hidden">
            <ContactBackground/>
            <motion.div initial="hidden" whileInView="show" variants={fadeWhileLoading(160, 200, 0)} viewport={{ once: true, amount: 0 }} className="container  mx-auto max-w-11/12 sm:max-w-4xl sm:px-18 relative">
                <ContactHeading/>
