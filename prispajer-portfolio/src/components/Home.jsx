  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-left flex-col gap-10 xs:w-[400px] sm:w-[500px]"
      >
        <div className="flex flex-col items-center sm:items-start text-[50px] xs:text-[50px] sm:text-[50px] font-bold font-headers text-secondary ">
